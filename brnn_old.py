...
def main(args):
    ...
    bidi_model.fit(x, preproc_french_sentences, epochs=args.epochs, batch_size=args.batch_size, 
                        validation_split=args.validation_split, callbacks=cb_list)

    print(logits_to_text(bidi_model.predict(x[:1])[0], french_tokenizer))


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--epochs",type=int,default=50,help="Number of iterations to run the algorithm")
    ...
    parser.add_argument("--patience",type=int,default=5,help="Minimum number of epochs to wait before triggering early stopping")
